...
10. ***Get [`More Plugins`](https://github.com/Tallytechzim/.gomo/edit/main/README.md)***
##
...
- *Tally-Md is not made by `WhatsApp Inc.` Sometimes or misusing the bot might `ban` your `WhatsApp account!`*
- *In that case, I'm not responsible for banning your account.*
- *Use Tally-Md at your own risk by keeping this warning in mind.*



## NOTE: Tally-MD SCRIPT IS NOT OPENLY ALLOWED TO USED IN ANY OF YOUR PROJECTS
